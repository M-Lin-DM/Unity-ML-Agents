...
using System.Linq;
using System.IO;
using MLAgents; //MRL added line to give writeadapter access to Agent.cs
...
//MRL: added MDATAget:
        ...
        public void AddRange(IEnumerable<float> data, int writeOffset = 0)//data here is m_observations created by the VectorSensor
        {
            if (m_Data != null)
            {
                int index = 0;
...
//MRL added write2csv
        ...
        {
            string filename = "D:/ml-agents-master/ml-agents-master/ObservationData/observation_data.csv";
